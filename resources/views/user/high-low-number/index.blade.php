                    ...
                    <table class="table table-bordered table-border-dark table-auto table-nowrap no-margin-bottom enable-check-all users__edit">
                      ...
                      <tbody>
                          <tr data-id="9474" data-status="1" class=" ">
                            ...
                            <td class="table-min-1-row-9474-col-min_1">{{ $play->min_1}}</td>
                            <td class="table-min-1-row-9474-col-min_2">{{ $play->min_2}}</td>
                            <td class="table-min-1-row-9474-col-min_3">{{ $play->min_3}}</td>
                            <td class="table-min-1-row-9474-col-min_4">{{ $play->min_4}}</td>
                            <td class="table-min-1-row-9474-col-min_5">{{ $play->min_5}}</td>
                            <td class="table-min-1-row-9474-col-min_6">{{ $play->min_6}}</td>
                            <td class="table-min-1-row-9474-col-min_7">{{ $play->min_7}}</td>
                            <td class="table-min-1-row-9474-col-min_8">{{ $play->min_8}}</td>
                          </tr>
                      </tbody>
                    @endforeach
                    </table>
                    ...
                    <table class="table table-bordered table-border-dark table-auto table-nowrap no-margin-bottom enable-check-all users__edit">
                      ...
                      <tbody>
                        <tr data-id="9474" data-status="1" class=" ">
                            ...
                            <td class="type" nowrap="">เมมเบอร์</td>
                            <td class="check"><input name="member_ids[]" type="checkbox" value="9474"></td>
                            <td class="table-min-2-row-9474-col-min_21">{{ $play->max_1}}</td>
                            <td class="table-min-2-row-9474-col-min_22">{{ $play->max_2}}</td>
                            <td class="table-min-2-row-9474-col-min_23">{{ $play->max_3}}</td>
                            <td class="table-min-2-row-9474-col-min_24">{{ $play->max_4}}</td>
                            <td class="table-min-2-row-9474-col-min_25">{{ $play->max_5}}</td>
                            <td class="table-min-2-row-9474-col-min_26">{{ $play->max_6}}</td>
                            <td class="table-min-2-row-9474-col-min_27">{{ $play->max_7}}</td>
                            <td class="table-min-2-row-9474-col-min_28">{{ $play->max_8}}</td>
                        </tr>
                      </tbody>
                    @endforeach
                    </table>
                      ...
                      <table class="table table-bordered table-border-dark table-auto table-nowrap no-margin-bottom enable-check-all users__edit">
                        ...
                        <tbody>
                          <tr data-id="9474" data-status="1" class=" ">
                              ...
                              <td class="type" nowrap="">เมมเบอร์</td>
                              <td class="check"><input name="member_ids[]" type="checkbox" value="9474"></td>
                              <td class="table-max-1-row-9474-col-max_1">{{$play->max_1}}</td>
                              <td class="table-max-1-row-9474-col-max_2">{{$play->max_2}}</td>
                              <td class="table-max-1-row-9474-col-max_3">{{$play->max_3}}</td>
                              <td class="table-max-1-row-9474-col-max_4">{{$play->max_4}}</td>
                              <td class="table-max-1-row-9474-col-max_5">{{$play->max_5}}</td>
                              <td class="table-max-1-row-9474-col-max_6">{{$play->max_6}}</td>
                              <td class="table-max-1-row-9474-col-max_7">{{$play->max_7}}</td>
                              <td class="table-max-1-row-9474-col-max_8">{{$play->max_8}}</td>
                          </tr>
                         @endforeach
                        </tbody>
                      </table>
                    ...
                    <table class="table table-bordered table-border-dark table-auto table-nowrap no-margin-bottom enable-check-all users__edit">
                      ...
                      <tbody>
                        <tr data-id="9474" data-status="1" class=" ">
                            ...
                            <td class="type" nowrap="">เมมเบอร์</td>
                            <td class="check"><input name="member_ids[]" type="checkbox" value="9474"></td>
                            <td class="table-max_per_num-1-row-9474-col-max_per_num_1">{{$play->max_per_num1}}</td>
                            <td class="table-max_per_num-1-row-9474-col-max_per_num_2">{{$play->max_per_num2}}</td>
                            <td class="table-max_per_num-1-row-9474-col-max_per_num_3">{{$play->max_per_num3}}</td>
                            <td class="table-max_per_num-1-row-9474-col-max_per_num_4">{{$play->max_per_num4}}</td>
                            <td class="table-max_per_num-1-row-9474-col-max_per_num_5">{{$play->max_per_num5}}</td>
                            <td class="table-max_per_num-1-row-9474-col-max_per_num_6">{{$play->max_per_num6}}</td>
                            <td class="table-max_per_num-1-row-9474-col-max_per_num_7">{{$play->max_per_num7}}</td>
                            <td class="table-max_per_num-1-row-9474-col-max_per_num_8">{{$play->max_per_num8}}</td>
                        </tr>    
                      </tbody>
                      @endforeach
                    </table>
