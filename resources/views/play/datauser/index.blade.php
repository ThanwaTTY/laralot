...
<div class="col-xs-12 no-padding-left">
  ...
  <div class="tab-content no-border no-padding">
    ...
    <form method="POST" action="https://www.superlot999.com/password" accept-charset="UTF-8" id="update-password-form" class="form-inline" autocomplete="off"><input name="_token" type="hidden" value="cxI7HPVE7hzMRArEEbzg8TH6cKD80y3OY5qZ6zkK">
