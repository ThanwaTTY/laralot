    ...
    <h1>
      ...
      <small>
                  <i class="ace-icon fa fa-angle-double-right"></i>
                      <a href="https://agent.superlot999.com/financial/transactions/show/9306/balance/date" class="ajax">3M3K</a>
                  
                  <i class="ace-icon fa fa-angle-double-right"></i>
          <select class="top-margin-10 member-list">
              <option value="">เมมเบอร์</option>

                              <option value="https://agent.superlot999.com/financial/transactions/show/9474/balance/date">3M3K001</option>
                              <option value="https://agent.superlot999.com/financial/transactions/show/10230/balance/date">3M3K002</option>
                              <option value="https://agent.superlot999.com/financial/transactions/show/11239/balance/date">3M3KPALM</option>
                              <option value="https://agent.superlot999.com/financial/transactions/show/11240/balance/date">3M3KTOR</option>
                              <option value="https://agent.superlot999.com/financial/transactions/show/12211/balance/date">3M3K003</option>
                        </select>
              </small>
    </h1>
  </div>
...
<form method="GET" action="https://agent.superlot999.com/financial/transactions/show/9306/balance" id="filter-form" class="form-inline bot-margin-20">
...
<div class="max-width-1100">
  <ul class="nav nav-tabs thick-border" id="tab-financial-requests">
    <li class="bigger-110 bolder active">
      <a href="#" class="width-110 center" data-toggle="tab" data-url="https://agent.superlot999.com/financial/transactions/show/9306/balance/date">ได้เสียสุทธิ</a>
    </li>
    <li class="bigger-110 bolder ">
      <a href="#" class="width-110 center" data-toggle="tab" data-url="https://agent.superlot999.com/financial/transactions/show/9306/credit/date">เครดิต</a>
    </li>
  </ul>
</div>
