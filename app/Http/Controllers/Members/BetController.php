                                                ...
                                                if($usebet_c->type=="top3"){
                                                    ...
                                                    if($usebet_c->amount_3 != 0){
                                                        if($usebet_c->amount_4 != 0){
                                                            ...
                                                            $comtop3[$key] += number_format(($usebet_c->amount_1+$usebet_c->amount_2)*$usebet_c->com_4/100-($usebet_c->amount_7-$usebet_c->amount_6-$usebet_c->amount_5-$usebet_c->amount_4)*$usebet_c->com_4/100,2);
                                                        }elseif($usebet_c->amount_5 != 0){
                                                            $sumtop3[$key] += number_format($usebet_c->amount_3,2);
                                                            $comtop3[$key] += number_format(($usebet_c->amount_1+$usebet_c->amount_2)*$usebet_c->com_4/100-($usebet_c->amount_7-$usebet_c->amount_6-$usebet_c->amount_5)*$usebet_c->com_5/100,2);
                                                        }elseif($usebet_c->amount_6 != 0){
                                                            $sumtop3[$key] += number_format($usebet_c->amount_3,2);
                                                            $comtop3[$key] += number_format(($usebet_c->amount_1+$usebet_c->amount_2)*$usebet_c->com_4/100-($usebet_c->amount_7-$usebet_c->amount_6)*$usebet_c->com_6/100,2);
                                                        }else{
                                                            $sumtop3[$key] += number_format($usebet_c->amount_3,2);
