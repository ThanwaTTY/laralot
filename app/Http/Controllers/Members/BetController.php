                                            ...
                                            if($level == 6){
                                                ...
                                                if($usebet_c->type=="top3"){
                                                   ...
                                                   // $comagtop3[$key] += number_format($usebet_c->amount_2*($usebet_c->com_2/100),2);
                                                    ...
                                                    if($usebet_c->amount_3 != 0){
                                                        $sumbottom3[$key] += number_format($usebet_c->amount_3+$usebet_c->amount_4+$usebet_c->amount_5+$usebet_c->amount_6,2);
                                                        $combottom3[$key] += number_format(($usebet_c->amount_7-$usebet_c->amount_6-$usebet_c->amount_5-$usebet_c->amount_4+$usebet_c->amount_3)*$usebet_c->com_3/100,2)-($usebet_c->amount_7*($usebet_c->com_7/100));
                                                    ...
                                                    if($usebet_c->amount_3 != 0){
                                                        $sumtod3[$key] += number_format($usebet_c->amount_3+$usebet_c->amount_4+$usebet_c->amount_5+$usebet_c->amount_6,2);
                                                        $comtod3[$key] += number_format(($usebet_c->amount_7-$usebet_c->amount_6-$usebet_c->amount_5-$usebet_c->amount_4+$usebet_c->amount_3)*$usebet_c->com_3/100,2)-($usebet_c->amount_7*($usebet_c->com_7/100));
                                                    ...
                                                    if($usebet_c->amount_3 != 0){
                                                        $sumtop2[$key] += number_format($usebet_c->amount_3+$usebet_c->amount_4+$usebet_c->amount_5+$usebet_c->amount_6,2);
                                                        $comtop2[$key] += number_format(($usebet_c->amount_7-$usebet_c->amount_6-$usebet_c->amount_5-$usebet_c->amount_4+$usebet_c->amount_3)*$usebet_c->com_3/100,2)-($usebet_c->amount_7*($usebet_c->com_7/100));
                                                    ...
                                                    if($usebet_c->amount_3 != 0){
                                                        $sumbottom2[$key] += number_format($usebet_c->amount_3+$usebet_c->amount_4+$usebet_c->amount_5+$usebet_c->amount_6,2);
                                                        $combottom2[$key] += number_format(($usebet_c->amount_7-$usebet_c->amount_6-$usebet_c->amount_5-$usebet_c->amount_4+$usebet_c->amount_3)*$usebet_c->com_3/100,2)-($usebet_c->amount_7*($usebet_c->com_7/100));
                                                    ...
                                                    if($usebet_c->amount_3 != 0){
                                                        $sumtod2[$key] += number_format($usebet_c->amount_3+$usebet_c->amount_4+$usebet_c->amount_5+$usebet_c->amount_6,2);
                                                        $comtod2[$key] += number_format(($usebet_c->amount_7-$usebet_c->amount_6-$usebet_c->amount_5-$usebet_c->amount_4+$usebet_c->amount_3)*$usebet_c->com_3/100,2)-($usebet_c->amount_7*($usebet_c->com_7/100));
                                                    ...
                                                    if($usebet_c->amount_3 != 0){
                                                        $sumtop1[$key] += number_format($usebet_c->amount_3+$usebet_c->amount_4+$usebet_c->amount_5+$usebet_c->amount_6,2);
                                                        $comtop1[$key] += number_format(($usebet_c->amount_7-$usebet_c->amount_6-$usebet_c->amount_5-$usebet_c->amount_4+$usebet_c->amount_3)*$usebet_c->com_3/100,2)-($usebet_c->amount_7*($usebet_c->com_7/100));
                                                    ...
                                                    if($usebet_c->amount_3 != 0){
                                                        $sumbottom1[$key] += number_format($usebet_c->amount_3+$usebet_c->amount_4+$usebet_c->amount_5+$usebet_c->amount_6,2);
                                                        $combottom1[$key] += number_format(($usebet_c->amount_7-$usebet_c->amount_6-$usebet_c->amount_5-$usebet_c->amount_4+$usebet_c->amount_3)*$usebet_c->com_3/100,2)-($usebet_c->amount_7*($usebet_c->com_7/100));
